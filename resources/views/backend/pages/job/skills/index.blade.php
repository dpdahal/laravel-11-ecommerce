                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="" method="post" onsubmit="addSkillsType(event)">
                                        @csrf
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 mt-3 mb-2">
                            <h2>
                                <i class="bi bi-eye"></i> Show Skills
                            </h2>
...
@section('scripts')
    <script>
        ...
        function addSkillsType(e) {
            ...
            axios.post('{{route('manage-skills.store')}}', sendData, {
                headers: {
                    'X-CSRF-TOKEN': token
                }
        ...
        function getAllData() {
            axios.get('{{route('manage-skills.all-skills')}}')
                .then(function (response) {
        ...
        function deleteSection(id) {
            ...
            axios.post('{{route('manage-skills.delete')}}', sendData)
                .then(function (response) {
                    if (response.data.success) {
                        Swal.fire({
                            icon: 'success',
        ...
        function editSection(id) {
            ...
            axios.post('{{route('manage-skills.edit')}}', sendData)
                .then(function (response) {
                    let data = response.data;
        ...
        function updateSection() {
            ...
            axios.post('{{route('manage-skills.update')}}', sendData, {
                headers: {
                    'X-CSRF-TOKEN': token
                }
            })
