                        ...
                        <div class="card-body pt-3">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade update-skills pt-3" id="update-skills">

                                        <div class="form-group mb-2">
                                            <label for="skill_id">Job Skill</label>
                                            <select class="form-select" name="skill_id[]" id="skill_id" multiple>
                                                @if($adminData->userSkill)
                                                    @foreach($adminData->userSkill as $js)
                                                        <option value="{{$js->id}}" selected>{{$js->name}}</option>
                                                    @endforeach
                                                @endif
                                                @foreach($skillsData as $skill)
                                                    @if(!$adminData->userSkill->contains($skill->id))
