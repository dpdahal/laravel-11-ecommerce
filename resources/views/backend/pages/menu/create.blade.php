                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mb-2 mt-3">
                                    <h2><i class="bi bi-plus-circle"></i> Add Menu
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="is_header" id="is_header"
                                                        class="form-control">
                                                    <option value="1"
                                                        {{old('is_header') == 1 ? 'selected' : ''}}>Yes
                                                    </option>
                                                    <option value="0"
                                                        {{old('is_header') == 0 ? 'selected' : ''}}>No
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="is_footer" id="is_footer"
                                                        class="form-control">
                                                    <option value="1"
                                                        {{old('is_footer') == 1 ? 'selected' : ''}}>Yes
                                                    </option>
                                                    <option value="0"
                                                        {{old('is_footer') == 0 ? 'selected' : ''}}>No
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="is_home" id="is_home"
                                                        class="form-control">
                                                    <option value="1"
                                                        {{old('is_home') == 1 ? 'selected' : ''}}> Yes
                                                    </option>
                                                    <option value="0"
                                                        {{old('is_home') == 0 ? 'selected' : ''}}>No
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-2">
