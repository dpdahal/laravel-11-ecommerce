@section('aside')
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            @endcan
            @if(auth()->user()->account_type->name=='admin' or auth()->user()->account_type->name=='vendor')
                <li class="nav-item">
                    <a class="nav-link collapsed" href="{{route('manage-store.index')}}">
                        <i class="bi bi-shop"></i>
                        <span>Mange Store</span>
                    </a>
                </li>
            @endif
            @can('banners_list')
